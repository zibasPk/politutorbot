...
export default function AddTutor(props)
{
  ...
  {
    let status = { code: 0 };
    let result = await makeCall(configData.botApiUrl + '/course', 'GET', "application/json",true, null, status);
...
{
  let status = { code: 0 };
  let result = await makeCall(configData.botApiUrl + '/tutor/' + action, 'POST', "application/json", true,
